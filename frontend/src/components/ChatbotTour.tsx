  ...
  const steps: Step[] = [
    {
      ...
      content: (
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-3">🎉 Welcome to Your AI Chatbot!</h3>
          <p className="text-slate-600 mb-4">
            Your AI-powered assistant is ready! Let's explore the key features together.
          </p>
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-4 border border-indigo-200">
            <p className="text-indigo-900 font-semibold text-sm mb-2">✨ What you can do:</p>
    ...
    },
    {
      ...
      content: (
        <div className="text-center">
          <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
            <span className="text-xl">💬</span>
          </div>
          <h3 className="text-lg font-semibold text-slate-900 mb-2">💬 Live Chat Preview</h3>
          ...
          <p className="text-xs text-indigo-600 mt-2">💡 Tip: Try asking in different languages to see auto-detection!</p>
        </div>
      ),
      placement: 'top',
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-lg font-semibold text-slate-900 mb-2">⚙️ Customize Your Chatbot</h3>
          <p className="text-slate-600 mb-3">
          ...
          <p className="text-xs text-indigo-600 mt-2">💡 Tip: Changes apply instantly to the preview!</p>
        </div>
      ),
      placement: 'left',
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-lg font-semibold text-slate-900 mb-2">🚀 Deploy to Your Website</h3>
          <p className="text-slate-600 mb-3">
          ...
          <ol className="text-sm text-slate-600 space-y-1 list-decimal list-inside">
            ...
            <li>Paste before <code className="bg-slate-100 px-1 rounded text-xs">&lt;/body&gt;</code> in your HTML</li>
    ...
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-lg font-semibold text-slate-900 mb-2">📊 Quick Integration</h3>
          <p className="text-slate-600 mb-3">
            Get your chatbot working in minutes:
          </p>
          <div className="space-y-3">
            <div>
              <p className="text-sm font-semibold text-slate-700">📝 For Regular Websites:</p>
              <p className="text-xs text-slate-600">Use the "Embedding Code" card → Copy & paste into your HTML</p>
            </div>
            <div>
              <p className="text-sm font-semibold text-slate-700">🛍️ For Shopify:</p>
              <p className="text-xs text-slate-600">Use "Shopify Integration" card → One-click OAuth connection</p>
            </div>
          </div>
          <p className="text-xs text-indigo-600 mt-2">💡 Tip: Check Dashboard for analytics after deployment!</p>
        </div>
      ),
      placement: 'left',
    },
    {
      ...
      content: (
        <div>
          ...
          <ol className="text-sm text-slate-600 space-y-2 list-decimal list-inside mb-3">
