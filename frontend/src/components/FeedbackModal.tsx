    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 sm:p-4 z-50">
      <div className="bg-white rounded-2xl max-w-lg w-full max-h-[90vh] sm:max-h-[70vh] overflow-y-auto p-4 sm:p-6 shadow-2xl">
        <div className="text-center mb-4">
          <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-1">💬 Help us improve AI Orchestrator</h3>
          <p className="text-xs sm:text-sm text-slate-600">Your feedback helps us build the perfect AI automation platform</p>
        </div>

        <form onSubmit={handleSubmit}>
          {/* Rating */}
          <div className="mb-4">
            <label className="block text-sm sm:text-sm font-medium text-slate-700 mb-2 sm:mb-3">
              ...
              <div className="grid grid-cols-1 gap-1 sm:gap-2">
                {[
                  ...
                  <label key={question} className="flex items-center py-1">
                    ...
                    />
                    <span className="text-xs sm:text-sm text-slate-700">{question}</span>
                  </label>
                ))}
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-3 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-50 font-medium transition-all duration-200"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 px-4 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-200">
            <div className="text-center">
              <h3 className="text-lg font-semibold text-indigo-800 mb-2"> Get Early Access</h3>
