    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <h3 className="font-semibold text-slate-900 mb-3 flex items-center">
              <EyeSlashIcon className="w-5 h-5 text-slate-400 mr-2" />
              Locked Features
            </h3>
            <ul className="space-y-2">
              {analytics.locked.map((feature, index) => (
                <li key={index} className="flex items-center text-sm text-slate-500">
                  <LockClosedIcon className="w-4 h-4 text-slate-400 mr-3" />
                  {feature}
                </li>
              ))}
            </ul>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Basic Metrics</h3>
          {children}
        </div>
        ...
        >
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Advanced Insights</h3>
            <div className="space-y-4">
              <div className="h-32 bg-slate-100 rounded-lg flex items-center justify-center">
                <span className="text-slate-500">Advanced Charts</span>
              </div>
              <div className="h-24 bg-slate-100 rounded-lg flex items-center justify-center">
                <span className="text-slate-500">Custom Reports</span>
              </div>
            </div>
          </div>
        </FeatureLock>
        ...
        >
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Custom Dashboards</h3>
            <div className="space-y-4">
              <div className="h-32 bg-slate-100 rounded-lg flex items-center justify-center">
                <span className="text-slate-500">Dashboard Builder</span>
              </div>
              <div className="h-24 bg-slate-100 rounded-lg flex items-center justify-center">
                <span className="text-slate-500">Widget Library</span>
              </div>
            </div>
          </div>
        </FeatureLock>
