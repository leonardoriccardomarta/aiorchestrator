    ...
    <div className="relative ml-4">
      ...
      >
        ...
        <span className="text-sm font-medium text-gray-900">
          {selectedChatbot?.name || 'All Chatbots'}
        </span>
              ...
              >
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  ...
                  <Bot className={`w-4 h-4 ${
                    !selectedChatbot ? 'text-white' : 'text-gray-600'
                  }`} />
                </div>
                <div className="flex-1 text-left">
                  <div className="text-sm font-medium text-gray-900">All Chatbots</div>
                  <div className="text-xs text-gray-500">Aggregated data from all chatbots</div>
                </div>
                {!selectedChatbot && (
