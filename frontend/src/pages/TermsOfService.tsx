      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Account Creation</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Account Responsibilities</h3>
          ...
          <section className="mb-12">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Billing and Cancellation</h3>
            <ul className="list-disc list-inside text-gray-600 mb-6 space-y-2">
          ...
          <section className="mb-12">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Our Rights</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Your Content</h3>
            <p className="text-gray-600 mb-4">
