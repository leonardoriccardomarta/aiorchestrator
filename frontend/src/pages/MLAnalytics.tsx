          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="p-6 bg-indigo-50 rounded-xl">
                ...
                <p className="text-sm text-slate-600">Real-time emotion detection and urgency scoring</p>
              </div>
              
              <div className="p-6 bg-purple-50 rounded-xl">
                <Zap className="w-8 h-8 text-purple-600 mx-auto mb-3" />
                <h4 className="font-semibold mb-2">Intent Classification</h4>
                <p className="text-sm text-slate-600">Smart routing based on customer intent</p>
              </div>
              
              <div className="p-6 bg-indigo-50 rounded-xl">
                <BarChart3 className="w-8 h-8 text-indigo-600 mx-auto mb-3" />
                <h4 className="font-semibold mb-2">Churn Prediction</h4>
                <p className="text-sm text-slate-600">Predict and prevent customer churn</p>
              </div>
            </div>

            <button
              onClick={() => navigate('/pricing')}
              className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold text-lg hover:shadow-lg transition-shadow"
            >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <div className="flex items-center justify-between bg-indigo-50 p-4 rounded-lg">
            <span className="text-sm text-slate-700">Average Sentiment Score</span>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <div className="bg-slate-50 p-4 rounded-lg">
              <div className="text-sm text-slate-600">Total Classified</div>
          ...
          <div className="space-y-2">
            {Object.entries(data.intent.intentPercentage).map(([intent, percentage]) => (
              <div key={intent} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-slate-600">Spam Blocked</span>
                <span className="font-bold">{data.anomaly.spamDetected}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-slate-600">Bots Detected</span>
        ...
        {data.churn && (
          <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl shadow-sm p-6 mt-6">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-4 rounded-lg">
                <div className="text-sm text-slate-600">Churn Prevented</div>
                <div className="text-2xl font-bold text-green-600">
              ...
              <div className="bg-white p-4 rounded-lg">
                <div className="text-sm text-slate-600">Prevention Rate</div>
