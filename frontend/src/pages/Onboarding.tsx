        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 lg:p-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
              {currentStepData.features.map((feature, index) => (
                <div key={index} className="flex items-center space-x-2 sm:space-x-3 p-3 sm:p-4 bg-gray-50 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <button
                onClick={handleNext}
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 active:from-blue-800 active:to-purple-800 transition-all duration-200 flex items-center justify-center space-x-2 touch-manipulation min-h-[44px] text-sm sm:text-base"
              >
                <span>
              ...
              <button
                onClick={handleSkip}
                className="bg-gray-100 text-gray-700 px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-gray-200 active:bg-gray-300 transition-all duration-200 touch-manipulation min-h-[44px] text-sm sm:text-base"
              >
                Salta per ora
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-6 sm:mt-8">
            <div 
              ...
              className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 cursor-pointer hover:shadow-xl active:shadow-md transition-all duration-200 border border-gray-100 touch-manipulation"
            >
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                <BarChart3 className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" />
                <h3 className="font-semibold text-sm sm:text-base text-gray-900">Dashboard</h3>
              </div>
              <p className="text-xs sm:text-sm text-gray-600">Vedi le tue statistiche e performance</p>
            </div>
            ...
            >
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                ...
                <h3 className="font-semibold text-sm sm:text-base text-gray-900">Impostazioni</h3>
              </div>
              <p className="text-xs sm:text-sm text-gray-600">Gestisci il tuo piano e account</p>
            </div>

            <div 
              onClick={() => navigate('/payments')}
              className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 cursor-pointer hover:shadow-xl active:shadow-md transition-all duration-200 border border-gray-100 touch-manipulation sm:col-span-2 lg:col-span-1"
            >
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                <CreditCard className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" />
                <h3 className="font-semibold text-sm sm:text-base text-gray-900">Piano</h3>
              </div>
              <p className="text-xs sm:text-sm text-gray-600">Visualizza e gestisci il tuo piano</p>
            </div>
          </div>
        </div>
      </div>
