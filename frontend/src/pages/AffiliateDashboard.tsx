    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-6 text-slate-600 text-xl font-medium">Loading affiliate dashboard...</p>
          <p className="mt-2 text-slate-500">Analyzing your affiliate performance</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="bg-white rounded-2xl shadow-2xl p-12 text-center">
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-8 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <div className="text-slate-600">Commission</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-purple-600 mb-2">€50</div>
                  <div className="text-slate-600">Min Payout</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-pink-600 mb-2">Monthly</div>
                  <div className="text-slate-600">Payments</div>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-bold text-lg hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg"
            >
            ...
            <button
              ...
              className="block w-full mt-4 px-8 py-3 bg-slate-100 text-slate-700 rounded-xl font-semibold hover:bg-slate-200 transition-all"
            >
              Back to Dashboard
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-slate-600 text-lg">Track your referrals and earnings</p>
            </div>
            <button
              onClick={() => navigate('/dashboard')}
              className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 font-semibold transition-all"
            >
              ← Main Dashboard
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-purple-500">
            ...
            <div className="text-slate-600 text-sm">Pending Payout</div>
            {stats.canRequestPayout && (
              <button
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-6">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-6 py-3 bg-white text-indigo-600 rounded-lg font-semibold hover:bg-slate-100 transition-all flex items-center gap-2"
              >
        ...
        <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl shadow-lg p-8 border-2 border-yellow-200">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900">Tips to Maximize Earnings</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-semibold text-slate-900 mb-1">Share on Social Media</div>
                <div className="text-slate-600 text-sm">Post your link on Twitter, LinkedIn, Facebook</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-semibold text-slate-900 mb-1">Write Blog Posts</div>
                <div className="text-slate-600 text-sm">Create content about AI chatbots and include your link</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-semibold text-slate-900 mb-1">Email Your Network</div>
                <div className="text-slate-600 text-sm">Reach out to businesses that could benefit</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-semibold text-slate-900 mb-1">Join Communities</div>
                <div className="text-slate-600 text-sm">Share in relevant online communities and forums</div>
              </div>
            </div>
          </div>
        </div>
