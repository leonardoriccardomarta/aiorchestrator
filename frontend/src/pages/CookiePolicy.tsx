        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Last updated: September 30, 2025</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 space-y-8">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  <li><code className="bg-gray-100 px-2 py-1 rounded">authToken</code> - Authentication and session management</li>
                  <li><code className="bg-gray-100 px-2 py-1 rounded">userData</code> - User preferences and settings</li>
                  <li><code className="bg-gray-100 px-2 py-1 rounded">planInfo</code> - Subscription plan details</li>
                </ul>
              </div>
          ...
          <section className="bg-blue-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700">
              ...
              <a href="mailto:privacy@aiorchestrator.com" className="text-blue-600 hover:underline">
