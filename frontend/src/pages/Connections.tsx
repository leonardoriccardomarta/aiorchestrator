...
const Connections: React.FC = () => {
  ...
  useEffect(() => {
    fetchConnections();
  }, [selectedChatbotId]); // Reload when chatbot changes
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'woocommerce': return 'bg-blue-500';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-500">Checking your store integrations</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div data-tour="connections-header">
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Store Connections</h1>
              <p className="text-gray-600 text-lg">Connect your e-commerce stores for seamless integration</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {connections.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">No store connections yet</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto" data-tour="store-types">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-lg transition-all duration-300">
                ...
                <h4 className="text-xl font-semibold text-gray-900 mb-2">Shopify</h4>
                <p className="text-gray-600 mb-6">Connect your Shopify store for automatic product and order sync.</p>
                <button
                  onClick={() => {
              ...
              <PlanLimitations feature="WooCommerce Connection" requiredPlan="professional">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-lg transition-all duration-300">
                  ...
                  <h4 className="text-xl font-semibold text-gray-900 mb-2">WooCommerce</h4>
                  <p className="text-gray-600 mb-6">Integrate with your WooCommerce store for seamless data sync.</p>
                  <button
                    onClick={() => {
              ...
              <PlanLimitations feature="Custom Store Connection" requiredPlan="enterprise">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-lg transition-all duration-300">
                  ...
                  <h4 className="text-xl font-semibold text-gray-900 mb-2">Custom Store</h4>
                  <p className="text-gray-600 mb-6">Connect any custom e-commerce solution via API.</p>
                  <button
                    onClick={() => {
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {connections.map((connection) => (
                <div key={connection.id} className="bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 overflow-hidden">
                  {/* Header */}
                  <div className="p-6 border-b border-gray-100">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 capitalize">{connection.type} Store</p>
                          <p className="text-xs text-gray-500">{connection.url}</p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-2xl font-bold text-gray-900">{connection.stats.syncedProducts.toLocaleString()}</div>
                      ...
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <div className="text-2xl font-bold text-blue-600">${connection.revenue.toLocaleString()}</div>
            ...
            {/* Sync Status */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6" data-tour="sync-status">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Sync Status</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">Total Products Synced</div>
                </div>
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">Total Orders Synced</div>
                </div>
                <div className="text-center">
