            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-indigo-600 rounded-full mt-2 mr-4"></div>
                  <div>
                    <h4 className="font-semibold text-slate-900">2024 Q1</h4>
                    <p className="text-slate-600">Company founded with core AI technology</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-indigo-600 rounded-full mt-2 mr-4"></div>
                  <div>
                    <h4 className="font-semibold text-slate-900">2024 Q2</h4>
                    <p className="text-slate-600">First 100 customers onboarded</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-indigo-600 rounded-full mt-2 mr-4"></div>
                  <div>
                    <h4 className="font-semibold text-slate-900">2024 Q3</h4>
                    <p className="text-slate-600">Multi-language support launched</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-indigo-600 rounded-full mt-2 mr-4"></div>
                  <div>
                    <h4 className="font-semibold text-slate-900">2024 Q4</h4>
                    <p className="text-slate-600">10,000+ businesses served worldwide</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-32 h-32 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                <span className="text-2xl font-bold text-white">AI</span>
              </div>
              <h3 className="text-xl font-semibold text-slate-900 mb-2">AI Research Team</h3>
              <p className="text-slate-600">
            ...
            <div className="text-center">
              <div className="w-32 h-32 bg-gradient-to-r from-green-500 to-indigo-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                <span className="text-2xl font-bold text-white">ENG</span>
              </div>
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Engineering Team</h3>
              <p className="text-slate-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Business Team</h3>
              <p className="text-slate-600">
