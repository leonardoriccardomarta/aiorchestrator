...
const Trial: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-6 sm:py-8 lg:py-12 px-3 sm:px-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
          {step === 1 && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                <div>
                  ...
                  <input
                    type="email"
                    required
                      className="w-full px-3 py-2 sm:py-2.5 bg-white text-slate-900 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:text-slate-500 text-sm sm:text-base touch-manipulation min-h-[44px]"
                ...
                <button 
                  type="submit" 
                  className="w-full bg-indigo-600 text-white py-2.5 sm:py-3 px-4 rounded-md font-semibold hover:bg-indigo-700 active:bg-indigo-800 transition-colors disabled:opacity-50 touch-manipulation min-h-[44px] text-sm sm:text-base"
                  disabled={isLoading}
                >
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-6 text-xs sm:text-sm text-slate-500">
          ...
          {step === 3 && (
            <div className="space-y-4 sm:space-y-6 text-center">
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-indigo-50 p-4 sm:p-6 rounded-lg">
                <h3 className="font-semibold text-sm sm:text-base mb-3 sm:mb-4">What happens next?</h3>
                <div className="space-y-2 sm:space-y-3 text-left">
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-medium flex-shrink-0">1</div>
                    <span className="text-xs sm:text-sm">Guided setup wizard (15 minutes)</span>
                  </div>
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-medium flex-shrink-0">2</div>
                    <span className="text-xs sm:text-sm">Deploy your first AI chatbot</span>
                  </div>
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-medium flex-shrink-0">3</div>
              ...
              <button 
                ...
                className="w-full bg-indigo-600 text-white py-2.5 sm:py-3 px-4 rounded-md font-semibold hover:bg-indigo-700 active:bg-indigo-800 transition-colors disabled:opacity-50 flex items-center justify-center touch-manipulation min-h-[44px] text-sm sm:text-base"
                disabled={isLoading}
              >
        ...
        <div className="mt-4 sm:mt-6 text-center">
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-4 text-xs text-slate-500">
