    ...
    <div className="group bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-xl hover:border-gray-300 transition-all duration-300">
      ...
      <div>
        ...
        <p className="text-3xl font-bold text-gray-900 mb-1">
          {prefix}{typeof value === 'number' && value !== undefined ? value.toLocaleString() : (value || 0)}{suffix}
        </p>
          ...
          <div className="flex items-center justify-between mt-1">
            ...
            {activity.value && (
              <span className="text-xs font-medium text-gray-700">
                ...
                {typeof activity.value === 'number' && activity.value !== undefined ? activity.value.toLocaleString() : (activity.value || 0)}
              </span>
            )}
          </div>
        </div>
