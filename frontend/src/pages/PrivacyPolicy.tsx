      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <h3 className="text-2xl font-semibold text-slate-900 mb-4">Personal Information</h3>
            <p className="text-slate-600 mb-4">
            ...
            <h3 className="text-2xl font-semibold text-slate-900 mb-4">Usage Information</h3>
            <p className="text-slate-600 mb-4">
          ...
          {/* Your Rights */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">Your Rights</h2>
            <p className="text-slate-600 mb-4">
            ...
            <p className="text-slate-600">
              To exercise these rights, please contact us at <a href="mailto:aiorchestratoor@gmail.com" className="text-indigo-600 hover:underline">aiorchestratoor@gmail.com</a>.
            </p>
          </section>
