    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <Link to="/blog" className="inline-flex items-center text-indigo-600 hover:text-indigo-700 font-semibold">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
            <article className="lg:col-span-8">
              ...
              {/* Key Takeaway */}
              <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4 sm:p-6 md:p-8 mt-6 sm:mt-8 md:mt-10">
              ...
              <div className="mt-6 sm:mt-8 md:mt-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 pt-6 sm:pt-8 border-t border-gray-200">
                <Link to="/blog" className="inline-flex items-center text-sm sm:text-base text-indigo-600 hover:text-indigo-700 active:text-indigo-800 font-medium transition-colors touch-manipulation min-h-[44px]">
                  <ArrowLeft className="w-4 h-4 mr-2 flex-shrink-0" /> Back to Blog
                </Link>
                <Link to="/#pricing" className="inline-flex items-center text-sm sm:text-base text-indigo-600 hover:text-indigo-700 active:text-indigo-800 font-medium transition-colors touch-manipulation min-h-[44px]">
            ...
            <aside className="lg:col-span-4 hidden lg:block">
              <div className="sticky top-24 space-y-4 sm:space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
                  ...
                  <div className="flex flex-col gap-2 sm:gap-3">
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-white border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 active:bg-indigo-100 transition-colors text-sm font-medium text-gray-700 min-h-[44px] touch-manipulation"
                    >
                ...
                {/* CTA */}
                <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-100 rounded-xl border border-indigo-100 p-4 sm:p-6">
                  ...
                  <Link
                    to="/#pricing"
                    className="inline-flex items-center justify-center w-full bg-gradient-to-r from-indigo-500 via-indigo-600 to-indigo-700 text-white px-4 py-2.5 rounded-lg hover:from-indigo-600 hover:to-indigo-800 transition-colors font-medium text-sm min-h-[44px] touch-manipulation shadow-sm"
                  >
