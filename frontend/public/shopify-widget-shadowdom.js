...
const translations = {
en: { productRecs: 'Product Recommendations', inStock: 'In Stock', outOfStock: 'Out of Stock', viewProduct: 'View Product', addToCart: 'Add to Cart', forYou: 'For You', addedToCart: 'Added to cart!', orderStatus: 'Order Status', customerHistory: 'Customer History', totalOrders: 'Total Orders', totalSpent: 'Total Spent', processing: 'Processing' },
it: { productRecs: 'Prodotti Consigliati', inStock: 'Disponibile', outOfStock: 'Non Disponibile', viewProduct: 'Vedi Prodotto', addToCart: 'Aggiungi al Carrello', forYou: 'Per Te', addedToCart: 'Aggiunto al carrello!', orderStatus: 'Stato Ordine', customerHistory: 'Storico Cliente', totalOrders: 'Ordini Totali', totalSpent: 'Spesa Totale', processing: 'In Elaborazione' },
...
fr: { productRecs: 'Recommandations', inStock: 'En Stock', outOfStock: 'Rupture', viewProduct: 'Voir', addToCart: 'Ajouter', forYou: 'Pour Vous', addedToCart: 'Ajouté au panier!', orderStatus: 'Statut de Commande', customerHistory: 'Historique Client', totalOrders: 'Commandes Totales', totalSpent: 'Total Dépensé', processing: 'En Traitement' },
...
pt: { productRecs: 'Recomendações', inStock: 'Disponível', outOfStock: 'Esgotado', viewProduct: 'Ver', addToCart: 'Adicionar', forYou: 'Para Você', addedToCart: 'Adicionado!', orderStatus: 'Status do Pedido', customerHistory: 'Histórico do Cliente', totalOrders: 'Pedidos Totais', totalSpent: 'Total Gasto', processing: 'Processando' },
ru: { productRecs: 'Рекомендации', inStock: 'Есть', outOfStock: 'Нет', viewProduct: 'Смотреть', addToCart: 'В корзину', forYou: 'Для вас', addedToCart: 'Добавлено!', orderStatus: 'Статус Заказа', customerHistory: 'История Клиента', totalOrders: 'Всего Заказов', totalSpent: 'Всего Потрачено', processing: 'В Обработке' },
zh: { productRecs: '推荐', inStock: '有货', outOfStock: '缺货', viewProduct: '查看', addToCart: '加入', forYou: '推荐', addedToCart: '已加入!', orderStatus: '订单状态', customerHistory: '客户历史', totalOrders: '总订单', totalSpent: '总花费', processing: '处理中' },
ja: { productRecs: 'おすすめ', inStock: '在庫あり', outOfStock: '在庫なし', viewProduct: '見る', addToCart: '追加', forYou: 'おすすめ', addedToCart: '追加しました!', orderStatus: '注文ステータス', customerHistory: '顧客履歴', totalOrders: '総注文数', totalSpent: '総支出', processing: '処理中' },
ko: { productRecs: '추천', inStock: '있음', outOfStock: '품절', viewProduct: '보기', addToCart: '추가', forYou: '추천', addedToCart: '추가됨!', orderStatus: '주문 상태', customerHistory: '고객 기록', totalOrders: '총 주문', totalSpent: '총 지출', processing: '처리 중' },
ar: { productRecs: 'توصيات', inStock: 'متوفر', outOfStock: 'نفذ', viewProduct: 'عرض', addToCart: 'أضف', forYou: 'لك', addedToCart: 'تمت الإضافة!', orderStatus: 'حالة الطلب', customerHistory: 'سجل العميل', totalOrders: 'إجمالي الطلبات', totalSpent: 'إجمالي الإنفاق', processing: 'قيد المعالجة' },
hi: { productRecs: 'सिफारिशें', inStock: 'उपलब्ध', outOfStock: 'खत्म', viewProduct: 'देखें', addToCart: 'जोड़ें', forYou: 'आपके लिए', addedToCart: 'जोड़ा गया!', orderStatus: 'ऑर्डर स्थिति', customerHistory: 'ग्राहक इतिहास', totalOrders: 'कुल आदेश', totalSpent: 'कुल खर्च', processing: 'प्रसंस्करण' }
};
