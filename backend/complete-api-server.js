                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="text-xs text-gray-600 flex items-center gap-2">
                            <div class="w-2 h-2 bg-green-500 rounded-full ${useCustomBranding && isProfessionalPlan ? 'notification-dot' : ''}"></div>
        ...
        <div class="h-96 overflow-y-auto p-4 bg-gray-50">
            <div class="mb-4 flex justify-start">
                <div class="max-w-[80%] rounded-2xl px-4 py-2 bg-white text-gray-900 border border-gray-200">
                    ...
                    <div class="text-xs mt-1 text-gray-500 ${useCustomBranding && isProfessionalPlan ? 'timestamp ai-message' : ''}">${new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true })}</div>
                </div>
            </div>
            <div class="mb-4 flex justify-end">
                <div class="max-w-[80%] rounded-2xl px-4 py-2 ${themeColors.userMessage} text-white">
                    ...
                    <div class="text-xs mt-1 text-white opacity-80 ${useCustomBranding && isProfessionalPlan ? 'timestamp user-message' : ''}">${new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true })}</div>
                </div>
            </div>
...
app.get('/api/user/profile', authenticatePayment, async (req, res) => {
  try {
    ...
    console.log('🔑 Generated new token for user profile:', freshUser.id);
