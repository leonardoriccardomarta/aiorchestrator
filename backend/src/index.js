...
var gracefulShutdown = function (signal) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                logger_1.logger.error('Error during shutdown:', error_1);
                process.exit(1);
                return [3 /*break*/, 4];
...
app.listen(PORT, function () {
    logger_1.logger.info("\uD83D\uDE80 AI Orchestrator API server running on port ".concat(PORT));
    logger_1.logger.info("\uD83D\uDCCA Environment: ".concat(config_1.config.NODE_ENV));
    logger_1.logger.info("\uD83C\uDF10 CORS Origin: ".concat(config_1.config.CORS_ORIGIN));
    logger_1.logger.info("\uD83D\uDD17 API Base URL: ".concat(config_1.config.API_BASE_URL));
});
exports.default = app;
